...
because redux saga makes the code look  synchronously
...
export function* OnToggleDrivers() {
  ...
  */
  ...
  /*
  redux saga takeLatest vs takeEvery : takeEvery allows
   multiple fetchData instances to be started concurrently. 
  Unlike takeEvery, takeLatest allows only one fetchData task
